      ...
      <div className="grid lg:grid-cols-12 gap-8">
        <section className="lg:col-span-7 space-y-4">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {["First Name", "Last Name", "Phone Number", "Street Address", "City", "ZIP Code"].map((field) => (
        ...
        <aside className="lg:col-span-5 border rounded-xl p-5 bg-white h-fit">
          ...
          {items.length === 0 ? (
            <div className="space-y-3">
              <p className="text-gray-600">Your cart is empty. Add products to place your order.</p>
